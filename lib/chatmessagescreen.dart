              ...
              child: CustomScrollView(
                  ...
                  slivers: [
                    SliverAppBar(
                      backgroundColor: Colors.black,
                      pinned: true,
                      collapsedHeight:orientIsPortrait? MediaQuery.of(context).size.height * .16 : MediaQuery.of(context).size.height * (120/924),
                      flexibleSpace: Container(
                        height:orientIsPortrait? MediaQuery.of(context).size.height * .15 : MediaQuery.of(context).size.height * (120/924),
                    ...
                    SliverToBoxAdapter(
                      child: SizedBox(
                        height: orientIsPortrait? MediaQuery
                            .of(context)
                            .size
                            .height * 0.79 : MediaQuery.of(context).size.height *0.655,
                    ...
                    // SliverToBoxAdapter(
                    //   child: Container(
                    //     height: orientIsPortrait ? MediaQuery.of(context).size.height * .074 : MediaQuery.of(context).size.height *.13,
                    //     // padding:
                    //     // const EdgeInsets.symmetric(horizontal: 5, vertical: 5),
                    //     color: Color(0xff242426),
                    //     child: Row(
                    //       children: [Expanded(flex: 6, child: Container(
                    //         height: orientIsPortrait ? MediaQuery.of(context).size.height * .05 : MediaQuery.of(context).size.height *.10,
        ...
        child: Column(children: <Widget>[
          Align(
            ...
            child: Container(
              ...
              child: const Text(
                'This ia message that is sent through this phone ... set up this one ',
                style: TextStyle(color: Colors.white),
              ),
            ),
          ),
